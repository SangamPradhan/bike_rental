          ...
          <div class="row staff-row" id="1">
              ...
              <div class="about-box-container mb-5 gx-4 gy-4">
                <div class="">
                  <div class="card border-0 doctor-card about-box">
                    <img class="card-img-top" src="{{ $staff->getImage() ?? asset('assets/img/StaffPotrait.jpg') }}"
            ...
            <div class="col-xl-8 px-5 d-flex">
              <div class="doctor-bio">
                <span
                  class="staff-designation mb-4">{{ $staff->designation == 'Accountant' ? 'Junior ' : '' }}{{ $staff->designation }}</span>
                <h3 class="staff-name">{{ $staff->name }}</h3>

                <div class="bio-text">
                  <div data-aos="fade-up" data-aos-delay="100" class="aos-init pb-2">{!! $staff->introduction !!}</div>
                </div>
